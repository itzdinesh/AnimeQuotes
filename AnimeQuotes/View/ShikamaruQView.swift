...
struct ShikamaruQView: View {
    ...
    var body: some View {
        ...
        ZStack{
            VStack{
            List{
                    Section(header: Image("ShikamaruNara")
                        .resizable()
                        .scaledToFit()
                        .cornerRadius(20)
                        .shadow(radius: 10)
                    ...
                    ForEach(itachiQuotesVm.shikamaruQuoteArr, id: \.self) { item in
...
struct ShikamaruQView_Previews: PreviewProvider {
